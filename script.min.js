    ...
    if (dataLoaded) {
        ...
        function initializeTokenSelection() {
            ...
            if (!tokensData || tokensData.length === 0) {
                 ...
                 // Error message should already be displayed by loadTokenData failure
                 return;
            }
            ...
            // Populate Random Display
            const shuffledTokens = shuffleArray([...tokensData]);
            const tokensToShow = shuffledTokens.slice(0, 5); // Get first 5 random
            ...
            tokensToShow.forEach(token => {
             ...
             console.log("Token selection initialized.");
        }
